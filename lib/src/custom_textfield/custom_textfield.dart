...
class BeautyTextfield extends StatefulWidget {
  ...
  const BeautyTextfield({
    ...
    this.fontSize = 12,
    this.isFocusIconColor = Colors.grey,
    this.isNotFocusIconColor = Colors.grey,
  })  : assert(width != null),
        assert(height != null),
                ...
                widget.prefixIcon == null
                    ...
                    : Expanded(
                        ...
                        child: Icon(
                          ...
                          color: isFocus
                              ? widget.isFocusIconColor
                              : widget.isNotFocusIconColor,
                        ),
                      ),
                Expanded(
                  flex: 5,
                  child: Container(
                    ...
                    child: TextField(
                      ...
                      decoration: InputDecoration(
                        hintStyle: TextStyle(
                          color:
                              isFocus ? widget.isFocusTextColor : Colors.grey,
                        ),
